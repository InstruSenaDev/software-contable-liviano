...
const { saludo, usuarios, roles, registerUser, inicioUser, registerProviders, proveedores, cuentas, usuariosLog, obtenerUsuarioPorCorreo,eliminarProveedor, eliminarUsuario } = require('./controller');
